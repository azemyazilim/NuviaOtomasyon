...
class Urun(models.Model):
    ...
    # Benzersiz ürün kodu
    urun_kodu = models.CharField(max_length=5, unique=True, verbose_name="Ürün Kodu (5 hane)", blank=True)
    ...
    cinsiyet = models.CharField(max_length=10, choices=CINSIYET_SECENEKLERI, default='unisex', verbose_name="Cinsiyet")
